        ...
        return match($type){
            ...
            'product' => [
                ...
                'leaves' => [
                    ...
                    ['slug' => 'gallery', 'type' => 'component', 'description' => 'блок ГЛАВНОЕ ФОТО + полоска миниатюр под/рядом с ним, где клик по миниатюре меняет главное фото — только если на странице ЕСТЬ отдельная полоска миниатюр (не просто одна картинка — та уже покрыта слотом "image"). Если миниатюр нет — не включай этот слот вовсе'],
