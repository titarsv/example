...
function updateCartUI(cart) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-cart-count').text(cart.count).toggleClass('d-none', !cart.count);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-cart-body').html(cart.html);
}
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-add-to-cart', function (e) {
  e.preventDefault();
  ...
  var $variation = $btn.closest('.js-product-card').find('[name="variation"]:checked');
  if ($variation.length) {
    data.variation = $variation.val();
  }
  jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/cart/update', data, function (cart) {
    updateCartUI(cart);
    var offcanvas = bootstrap__WEBPACK_IMPORTED_MODULE_1__.Offcanvas.getOrCreateInstance(document.getElementById('cartOffcanvas'));
    offcanvas.show();
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-cart-remove', function (e) {
  e.preventDefault();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', '.js-cart-qty', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/cart/update', {
    action: 'update',
    product_id: jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('id'),
...
function showToast(message, variant) {
  ...
  var $container = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#js-toast-container');
  if (!$container.length) {
    $container = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div id="js-toast-container" class="position-fixed bottom-0 end-0 p-3" style="z-index:1080"></div>').appendTo('body');
  }
  var $toast = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="toast align-items-center text-bg-' + variant + ' border-0" role="alert">' + '<div class="d-flex">' + '<div class="toast-body"></div>' + '<button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Закрыть"></button>' + '</div>' + '</div>');
  $toast.find('.toast-body').text(message);
  $container.append($toast);
  var toast = new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Toast($toast[0], {
    delay: 5000
  });
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-compare-toggle', function (e) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/compare/toggle', {
    product_id: productId
  }).done(function (response) {
    var $buttons = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-toggle[data-id="' + productId + '"]');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-count').text(response.count).toggleClass('d-none', !response.count);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-dropdown').html(renderCompareGroups(response.groups));
    if (!response.in_compare && location.pathname.replace(/\/$/, '') === '/compare') {
      location.reload();
    }
  }).fail(function (xhr) {
    var message = xhr.responseJSON && xhr.responseJSON.message || 'Не удалось обновить список сравнения.';
    showToast(message);
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-compare-clear', function (e) {
  e.preventDefault();
  var categoryId = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('category');
  jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/compare/clear', {
...
function updateCompareStickyOffset() {
  var $sticky = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-sticky');
  if (!$sticky.length) {
    return;
  }
  var $nav = jquery__WEBPACK_IMPORTED_MODULE_0___default()('nav.navbar');
  var offset = $nav.length ? $nav.outerHeight() : 0;
  $sticky.css('top', offset + 'px');
}
jquery__WEBPACK_IMPORTED_MODULE_0___default()(updateCompareStickyOffset);
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('load resize', updateCompareStickyOffset);
...
var syncingCompareScroll = false;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('scroll', '.js-compare-sticky', function () {
  var $body = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.js-compare-wrapper').find('.js-compare-scroll');
  if ($body.length) {
    syncCompareScroll(this, $body[0]);
  }
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('scroll', '.js-compare-scroll', function () {
  var $header = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.js-compare-wrapper').find('.js-compare-sticky');
  if ($header.length) {
    syncCompareScroll(this, $header[0]);
  }
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', '.js-compare-diff-only', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-grid').toggleClass('js-diff-only-active', this.checked);
});
...
function compareShareUrl() {
  var ids = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-header-cell[data-id]').map(function () {
    return jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('id');
  }).get();
  if (!ids.length) {
...
function compareShareTitle() {
  var categoryName = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-wrapper').data('category-name') || '';
  return 'Сравнение товаров' + (categoryName ? ' | ' + categoryName : '');
}
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-compare-share-link', function (e) {
  e.preventDefault();
  var url = encodeURIComponent(compareShareUrl());
  var text = encodeURIComponent(compareShareTitle());
  var network = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('network');
  var targets = {
...
function fallbackCopy(text) {
  var $ta = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<textarea readonly></textarea>').css({
    position: 'fixed',
    left: '-9999px',
    top: '0'
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-compare-copy-link', function (e) {
  e.preventDefault();
...
function buildCompareRows() {
  var $headerCells = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-header-cell');
  var productCount = $headerCells.length;
  var header = [''];
  $headerCells.each(function () {
    header.push(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('.small.fw-normal').text().trim());
  });
  var rows = [header];
  var children = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-grid').children().toArray();
  for (var i = 0; i + productCount < children.length; i += 1 + productCount) {
    var $label = jquery__WEBPACK_IMPORTED_MODULE_0___default()(children[i]);
    if (!$label.hasClass('js-compare-label') || !$label.text().trim()) {
      break;
    }
    var row = [$label.text().trim()];
    for (var j = 1; j <= productCount; j++) {
      row.push(jquery__WEBPACK_IMPORTED_MODULE_0___default()(children[i + j]).text().trim());
    }
    rows.push(row);
  }
  return rows;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-compare-copy-table', function (e) {
  e.preventDefault();
  var rows = buildCompareRows();
  var tsv = buildCompareTsv(rows);
  if (window.ClipboardItem && navigator.clipboard && navigator.clipboard.write) {
    var html = buildCompareHtmlTable(rows);
...
function buildCompareAiData() {
  var categoryName = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-wrapper').data('category-name') || '';
  var $headerCells = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-compare-header-cell');
  var items = $headerCells.map(function () {
  ...
  for (var i = 0; i + productCount < children.length; i += 1 + productCount) {
    ...
    for (var j = 1; j <= productCount; j++) {
      items[j - 1].specs[name] = jquery__WEBPACK_IMPORTED_MODULE_0___default()(children[i + j]).text().trim();
    }
  }
  return {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-compare-copy-ai', function (e) {
  e.preventDefault();
  var json = JSON.stringify(buildCompareAiData(), null, 2);
  copyToClipboard(json, function () {
    showToast('Данные для ИИ скопированы', 'success');
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-compare-fullscreen', function () {
  var el = document.querySelector('.js-compare-wrapper');
  if (!el) {
    return;
  }
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-compare-move-left, .js-compare-move-right', function () {
  var $btn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  var $wrapper = $btn.closest('.js-compare-wrapper');
  var index = $btn.closest('.js-compare-header-cell').data('index');
  var targetIndex = $btn.hasClass('js-compare-move-left') ? index - 1 : index + 1;
  var ids = $wrapper.find('.js-compare-header-cell[data-id]').map(function () {
    return jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('id');
  }).get();
  ...
  ids[targetIndex] = tmp;
  jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/compare/reorder', {
    category_id: $wrapper.data('category'),
    ids: ids
  }, function () {
    location.reload();
  });
...
function submitCatalogFilters($form) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/products/filter', jquery__WEBPACK_IMPORTED_MODULE_0___default().param(data), function (response) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogProducts').html(response.html);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogPagination').html(response.pagination);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogFilterFields').html(response.filters);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogSelectedFilters').html(response.checked);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-products-count').text(response.count);
    if (response.link) {
...
function submitCatalogFiltersFromStart() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogFilters input[name="page"]').val(1);
  submitCatalogFilters(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogFilters'));
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', '.js-filter-single', function () {
  if (this.checked) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.accordion-body').find('.js-filter-single').not(this).prop('checked', false);
  }
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', '#catalogFilters input[type="checkbox"], #catalogFilters select[name="filters[]"]', submitCatalogFiltersFromStart);
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('submit', '#catalogFilters', function (e) {
  e.preventDefault();
...
function applyAttrRange($wrapper) {
  var min = parseFloat($wrapper.find('.js-attr-range-min-input').val());
  var max = parseFloat($wrapper.find('.js-attr-range-max-input').val());
  if (min > max) {
    var tmp = min;
    min = max;
    max = tmp;
  ...
  $wrapper.find('.js-attr-range-checkbox').each(function () {
    var value = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('numeric'));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).prop('checked', value >= min && value <= max);
  });
  submitCatalogFiltersFromStart();
}
var attrRangeTimer;
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('input change', '.js-attr-range-min-input, .js-attr-range-max-input', function () {
  clearTimeout(attrRangeTimer);
  var $wrapper = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.js-attr-range');
  attrRangeTimer = setTimeout(function () {
    applyAttrRange($wrapper);
  }, 300);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js_remove_filter', function () {
  ...
  if (type === 'attribute') {
    var $form = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogFilters');
    ...
    $form.find('select[name="filters[]"]').each(function () {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('option[value="' + id + '"]').prop('selected', false);
    });
  } else if (type === 'is_sale') {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogFilters').find('#isSale').prop('checked', false);
  }
  submitCatalogFiltersFromStart();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js_clear_filters', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogFilters')[0].reset();
  submitCatalogFiltersFromStart();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#catalogPagination .page-link', function (e) {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.page-item').hasClass('disabled')) {
    e.preventDefault();
    return;
  }
  e.preventDefault();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogFilters input[name="page"]').val(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('page'));
  submitCatalogFilters(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogFilters'));
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('html, body').animate({
    scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogProducts').offset().top - 100
  }, 300);
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', '.js-catalog-sort-select', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#catalogFilters input[name="order"]').val(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());
  submitCatalogFiltersFromStart();
});

// Быстрый просмотр товара — подгружаем разметку карточки в модалку.
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.js-quick-view', function (e) {
  e.preventDefault();
  var id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('id');
  var $modalBody = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#quickViewModal .modal-body');
  $modalBody.html('<div class="text-center py-5"><div class="spinner-border" role="status"></div></div>');
  bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal.getOrCreateInstance(document.getElementById('quickViewModal')).show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/product_popup', {
    id: id
  }, function (html) {
    $modalBody.html(html);
  });
...
var searchTimer;
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('input', '.js-live-search', function () {
  var $input = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  var $results = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-search-results');
  ...
  searchTimer = setTimeout(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().get('/livesearch', {
      text: text
    }, function (products) {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', function (e) {
  if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest('.js-search-wrapper').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-search-results').removeClass('show').addClass('d-none');
  }
});
...
/***/ "./resources/themes/base/scss/app.scss":
/*!*********************************************!*\
  !*** ./resources/themes/base/scss/app.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"/themes/base/js/app": 0,
/******/ 			"themes/base/css/app": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkproject_builder"] = self["webpackChunkproject_builder"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["themes/base/css/app"], () => (__webpack_require__("./resources/themes/base/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["themes/base/css/app"], () => (__webpack_require__("./resources/themes/base/scss/app.scss")))
