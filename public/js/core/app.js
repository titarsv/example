  ...
  $(window).on("load", function () {
    ...
    */
    function checkTextAreaMaxLength(textBox, e) {
      ...
      let parent = $(textBox).parents('div').first();
      parent.find(".char-count").html(textBox.value.length)

      if (textBox.value.length > maxLength) {
        parent.find(".counter-value").css("background-color", $danger)
        parent.find(".char-textarea").css("color", $danger)
        // to change text color after limit is maxedout out
        parent.find(".char-textarea").addClass("max-limit")
      } else {
        parent.find(".counter-value").css("background-color", $primary)
        parent.find(".char-textarea").css("color", $textcolor)
        parent.find(".char-textarea").removeClass("max-limit")
      }
