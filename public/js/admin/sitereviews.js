...
$(document).ready(function () {
        ...
        },
        {
          ...
          render: function ( data, type, row ) {
            return '<div class="custom-switch custom-switch-success">\n' +
              '<input type="checkbox" class="custom-control-input js_change_status" data-endpoint="reviews/site"\n' +
            ...
            for(let i in data){
              ...
              if(typeof data[i].type !== 'undefined'){
                if(data[i].type === 'edit'){
                  ...
                  html += '<span class="review-action-edit cursor-pointer js_delete_item" data-endpoint="reviews/site" data-id="'+data[i].id+'" data-name="'+data[i].name+'">'+ text +'</span>';
                }
  ...
  if($('.snow-container .detail-view-editor').length){
      ...
      $('#js_answer_btn').click(function(){
          ...
          sendData('/admin/reviews/site/update_answer/' + id, data);
      });
  }
