...
$(document).ready(function () {
  ...
  if ($(".categories-data-table").length) {
    ...
    let dataListView = $(".categories-data-table").DataTable({
      ajax: {
        url: '/admin/content/categories/list',
        type: "POST"
      },
      ...
      columns: [
        ...
        {
          data: 'sort_order',
          name: 'content_categories.sort_order'
        },
        {
          data: 'status',
          name: 'content_categories.status',
          render: function ( data, type, row ) {
            ...
            for(let i in data){
              ...
              if(typeof data[i].type !== 'undefined'){
                if(data[i].type === 'edit'){
                  ...
                  html += '<span class="category-action-edit cursor-pointer js_delete_item" data-endpoint="content/categories" data-id="'+data[i].id+'" data-name="'+data[i].name+'">'+ text +'</span>';
                }
  ...
  $('#js_add_category').on('click', function () {
    Swal.fire({
      ...
      preConfirm: function (name) {
        return fetch("/admin/content/categories/create", {
          method: 'POST',
          headers: {
