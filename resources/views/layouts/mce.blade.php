...
<script type="text/javascript">
    tinyMCEPreInit = {
        baseURL: "/js/scripts/larchik/tinymce",
        suffix: ".min",
        dragDropUpload: true,
        mceInit: {
            @foreach($editors as $i => $editor_id)
                ...
                '{{ $editor_id }}':{
                    ...
                    content_css:"/css/larchik/dashicons.min.css,/js/scripts/larchik/tinymce/skins/wordpress/wp-content{{ $configData['theme'] === 'dark' ? '-dark' : '' }}.css",
