...
{{--                    <a href="{{ base_url('/login/google') }}" class="btn btn-social btn-google btn-block font-small-3--}}{{-- mr-md-1--}}{{-- mb-md-0 mb-1">--}}
{{--                      <i class="bx bxl-google font-medium-3"></i>--}}
{{--                      <span class="pl-50 d-block text-center">Google</span>--}}
{{--                    </a>--}}
                    {{--<a href="{{ base_url('/login/facebook') }}" class="btn btn-social btn-block mt-0 btn-facebook font-small-3">--}}
...
{{--                      <small>or log in using email</small>--}}
{{--                    </div>--}}
{{--                  </div>--}}
...
{{--                        <a href="{{asset('/lost-password')}}" class="card-link"><small>Recover password?</small></a>--}}
{{--                      </div>--}}
                    </div>
...
{{--                    <a href="{{asset('/registration')}}"><small>Register</small></a>--}}
{{--                  </div>--}}
                </div>
              </div>
            </div>
