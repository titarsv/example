  ...
  <div class="app-file-sidebar-left">
    ...
    <div class="app-file-sidebar-content">
      ...
      <div class="list-group list-group-messages my-50">
        <a href="/admin/media" class="list-group-item list-group-item-action pt-0 active">
          <div class="fonticon-wrap d-inline mr-25">
            <i class="livicon-evo"
              data-options="name: morph-folder.svg; size: 24px; style: lines; strokeColor:#5A8DEE; eventOn:grandparent; duration:0.85;"></i>
          </div>
          All Files
          <span class="badge badge-light-primary badge-pill badge-round float-right mt-50">{{ $active }}</span>
        </a>
        {{--<a href="/admin/media/important" class="list-group-item list-group-item-action">--}}
          {{--<div class="fonticon-wrap d-inline mr-25">--}}
            {{--<i class="livicon-evo"--}}
              {{--data-options="name: morph-star.svg; size: 24px; style: lines; strokeColor:#475f7b; eventOn:grandparent; duration:0.85;"></i>--}}
          {{--</div>--}}
          {{--Important--}}
          {{--<span class="badge badge-light-secondary badge-pill badge-round float-right mt-50">{{ $trashed }}</span>--}}
        {{--</a>--}}
        <a href="/admin/media/trash" class="list-group-item list-group-item-action">
          <div class="fonticon-wrap d-inline mr-25">
            <i class="livicon-evo"
              data-options="name: trash.svg; size: 24px; style: lines; strokeColor:#475f7b; eventOn:grandparent; duration:0.85;"></i>
          </div>
          Deleted Files
          <span class="badge badge-light-danger badge-pill badge-round float-right mt-50">{{ $trashed }}</span>
        </a>
      </div>
      ...
      <div class="list-group list-group-labels my-50">
        <a href="/admin/media/images" class="list-group-item list-group-item-action">
          <div class="fonticon-wrap d-inline mr-25">
            <i class="livicon-evo"
        ...
        <a href="/admin/media/documents" class="list-group-item list-group-item-action pt-0">
          <div class="fonticon-wrap d-inline mr-25">
            <i class="livicon-evo"
        ...
        <a href="/admin/media/videos" class="list-group-item list-group-item-action">
          <div class="fonticon-wrap d-inline mr-25">
            <i class="livicon-evo"
              data-options="name: camcoder.svg; size: 24px; style: lines; strokeColor:#475f7b; eventOn:grandparent; duration:0.85;"></i>
          </div> Videos
        </a>
        <a href="/admin/media/audio" class="list-group-item list-group-item-action">
          <div class="fonticon-wrap d-inline mr-25">
            <i class="livicon-evo"
        ...
        <a href="/admin/media/zip" class="list-group-item list-group-item-action">
          <div class="fonticon-wrap d-inline mr-25">
            <i class="livicon-evo"
      ...
      <div class="d-flex mb-1">
        ...
        <div class="file-manager-progress">
          <span class="text-muted font-size-small">{{ $used_space }} used of {{ $total_space }}</span>
