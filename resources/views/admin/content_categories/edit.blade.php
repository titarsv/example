                ...
                <div class="card-body">
                    <ul class="nav nav-tabs mb-2" role="tablist">
                        ...
                        <li class="custom-control custom-switch custom-switch-success">
                            ...
                            <input type="checkbox" class="custom-control-input js_change_status" data-endpoint="content/categories"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active fade show" id="information" aria-labelledby="information-tab" role="tabpanel">
                            ...
                            <form action="/admin/content/categories/edit/{{ $category->id }}" method="post" class="js_ajax_form" id="category_form" novalidate>
                                {!! csrf_field() !!}
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col">
                                                <div class="field-group">
                                                    <div class="row">
                                                        <div class="col-sm-10">
                                                            <label>{{ trans('locale.Category name') }}</label>
                                                        ...
                                                        <div class="col-sm-2">
                                                            <label>{{ trans('locale.Color') }}</label>
                                                            @include('admin.layouts.form.color', [
                                                             'key' => 'color',
                                                             'item' => $category,
                                                             'required' => true
                                                            ])
                                                ...
                                                <div class="field-group">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <label>{{ trans('locale.Parent category') }}</label>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label>{{ trans('locale.Sort order') }}</label>
                                                            @include('admin.layouts.form.string', [
                                                             'key' => 'sort_order',
                                                             'item' => $category,
                                                             'languages' => null
                        ...
                        <div class="tab-pane fade show" id="seo" aria-labelledby="seo-tab" role="tabpanel">
                            ...
                            <form action="/admin/content/categories/seo/{{ $category->id }}" method="post" class="js_ajax_form" novalidate>
                                {!! csrf_field() !!}
