        ...
        <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
          ...
          <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block">
              <a class="nav-link" href="{{ url()->previous() }}" data-toggle="tooltip" data-placement="top" title="{{ trans('locale.Previous') }}">
                <i class="ficon bx bx-undo"></i>
              </a>
            </li>
            {{--<li class="nav-item d-none d-lg-block">--}}
              {{--<a class="nav-link" href="{{ asset('/admin/orders') }}" data-toggle="tooltip" data-placement="top" title="{{ __('locale.Orders') }}">--}}
                {{--<i class="ficon bx bx-cart-alt"></i>--}}
              {{--</a>--}}
            {{--</li>--}}
            {{--<li class="nav-item d-none d-lg-block">--}}
              {{--<a class="nav-link" href="{{ asset('/admin/products') }}" data-toggle="tooltip" data-placement="top" title="{{ __('locale.Products') }}">--}}
                {{--<i class="ficon bx bx-store"></i>--}}
              {{--</a>--}}
            {{--</li>--}}
...
{{--              <i class="flag-icon flag-icon-{{ $locale == 'en' ? 'us' : $locale }}"></i><span class="selected-language">{{ $languages_names[$locale] }}</span>--}}
{{--            </a>--}}
{{--            <div class="dropdown-menu" aria-labelledby="dropdown-flag">--}}
{{--              <a class="dropdown-item" href="{{url('lang/en')}}" data-language="en">--}}
{{--                <i class="flag-icon flag-icon-us mr-50"></i> English--}}
{{--              </a>--}}
{{--              <a class="dropdown-item" href="{{url('lang/ua')}}" data-language="ua">--}}
{{--                <i class="flag-icon flag-icon-ua mr-50"></i> Українська--}}
{{--              </a>--}}
          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              <div class="user-nav d-sm-flex d-none">
                <span class="user-name">{{ $me->first_name }} {{ $me->last_name }}</span>
                <span class="user-status text-muted">{{ $me->roles->first()->name }}</span>
              </div>
              <span><img class="round" src="{{asset($me->photo)}}" alt="avatar" height="40" width="40"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right pb-0">
              <a class="dropdown-item" href="/admin/users/profile">
                <i class="bx bx-user mr-50"></i> {{ trans('locale.Edit Profile') }}
              </a>
              ...
              <a class="dropdown-item" href="/logout"><i class="bx bx-power-off mr-50"></i> {{ trans('locale.Logout') }}</a>
            </div>
          </li>
        </ul>
      </div>
