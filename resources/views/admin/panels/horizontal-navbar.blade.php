    ...
    <ul class="nav navbar-nav flex-row">
      ...
      <a class="navbar-brand" href="{{asset('/')}}">
          <div class="brand-logo">
            <svg class="properloud-logo" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 27 25" style="enable-background:new 0 0 27 25;width: 26px;margin-top: -10px;margin-left: 4px;" xml:space="preserve">
                            <style>
                              .st0{fill:none;stroke:#F25733;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
                              .properloud{width: max-content;color:#fff;text-decoration: none;}
                              .properloud:hover .st1{fill:#F25733;stroke:#F25733;}
                              .properloud span{color:#939393;text-decoration: none;font-family: arial, sans-serif;font-size: 12px;fill: none;stroke: none;margin-right: 5px}
                              .properloud:hover span{color:#939393;text-decoration: none;fill: none;stroke: none;}
                            </style>
    ...
    <div class="navbar-container content">
      <div class="navbar-collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav float-right d-flex align-items-center">
          <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-ru"></i><span class="selected-language d-lg-inline d-none">Русский</span></a>
