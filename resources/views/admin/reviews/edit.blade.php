                                ...
                                <div class="pr-1">
                                    <div class="list-left d-flex">
                                        <div class="list-icon mr-1">
                                            <div class="avatar avatar-xl bg-rgba-primary m-0">
                                                <img class="img-fluid" src="{{ $review->product->image->url() }}" alt="img placeholder" height="38" width="38">
                                            </div>
                                        </div>
                                        <div class="list-content">
                                            <span class="list-title">{{ $review->product->name }}</span>
                                            <small class="text-muted d-block">{{ sprintf(config('site.modules.shop.currencies.'.config('site.modules.shop.main_currency').'.pricing_template'), $review->product->price) }}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="information">
                                <a class="mr-1" href="/admin/products/edit/{{ $review->product->id }}" target="_blank"><i class="bx bx-edit-alt" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit"></i></a>
                                <a class="mr-1" href="{{ $review->product->link() }}" target="_blank"><i class="bx bx-show" data-toggle="tooltip" data-placement="bottom" data-original-title="Show"></i></a>
                            </div>
                        </div>
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="collapse-title media">
                            ...
                            <div class="information">
                                <div class="custom-control custom-switch custom-switch-success d-sm-flex d-none align-items-center">
                                    ...
                                    <input type="checkbox"
                                           ...
                                           data-endpoint="reviews/products"
                                           name="published"
                                           value="1"
                                           form="review_form"
                                           id="js_review_status"
...
{{--                                            data-endpoint="reviews/products/favorite"--}}
{{--                                            name="favorite"--}}
{{--                                            value="1"--}}
{{--                                            form="review_form"--}}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <form action="/admin/reviews/products/media/{{ $review->id }}" id="js_review_media_form" method="post">
